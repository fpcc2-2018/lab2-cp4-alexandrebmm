...
#events_original = events_original %>% slice(1:1000) # Útil para testar código em dados pequenos. Comente na hora de processá-los para valer.
...
searches = events %>% 
    ...
    summarise(
        ...
        session_length = max(timestamp) - min(timestamp),
